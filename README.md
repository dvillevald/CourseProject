...
In addition to the instructions below, the Python script **demo.py** has detailed comments on each step. Also, [this video](https://youtu.be/H9MoPwvfUus) shows how to run the script.
